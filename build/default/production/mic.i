...
void handleEmergencyCalls(unsigned char en) {
    ...
    mic1_state(detectStatePTT(config.zone_sel1, 17,&mic1Thresholds));
    mic2_state(detectStatePTT(config.zone_sel2, 14,&mic1Thresholds));
    mic3_state(detectStatePTT(config.zone_sel3, 3,&mic1Thresholds));
...
void mic1_state(unsigned int PTT1){
    ...
    if (PTT1 == 2 && press1 == 0 && press_all == 0) {
        dry_c = 0;
        line_test_on = 1;
        tmr_line_tst = 0;
        press1 = 1;
    ...
    } else if (PTT1 == 1 && mic1_not_prs == 0 && press1 == 1) {
...
void mic2_state(unsigned int PTT2){
    ...
    if (PTT2 == 2 && press2 == 0 && press_all == 0) {
    ...
    } else if (PTT2 == 1 && mic2_not_prs == 0 && press2 == 1) {
        vol_set2 = 0;
        mic2_short = 0;
        mic2_cut = 0;
        line_test_on = 0;
...
void mic3_state(unsigned int PTT3){
    ...
    if (PTT3 == 2 && press3 == 0 && press_all == 0) {
...
# 362 "mic.c"
        shiftRegisterData &= ~((unsigned int)((1 << 2) | (1 << 3) | (1 << 4) |(1 << 5) | (1 << 6) | (1 << 7)));
    ...
    }else if(PTT3 == 1 && mic3_not_prs == 0 && press_all == 1){
        press_all = 0;
        press3 = 0;
        mic3_cut = 0;
        mic3_short = 0;
...
void handleDryCont_3_4(unsigned char st) {
    unsigned char statePTT3 = (m1_inv == 0 && m2_inv == 0) ? PTT_3() : 1;
    unsigned char statePTT4 = (m1_inv == 0 && m2_inv == 0) ? PTT_4() : 1;
    ...
    if (st && press_all == 0) {
        ...
        if (statePTT3 == 0) {
            ...
            jq8900_stop();
            all_alarms &= ~(1 << 2);
            shiftRegisterData &= ~((unsigned int) ((1 << 4) | (1 << 5) | (1 << 8) | (1 << 9)));
            if (statePTT3 && statePTT4 == 1) {
                zone1State = 0;
                zone2State = 0;
            }
...
void loadMic1Thresholds(void) {
    ...
    mic1Thresholds.ok_min = EEPROM_Read16(0x20);
    mic1Thresholds.ok_max = EEPROM_Read16(0x22);
    mic1Thresholds.pr_min = EEPROM_Read16(0x24);
    mic1Thresholds.pr_max = EEPROM_Read16(0x26);
    mic1Thresholds.ct_min = EEPROM_Read16(0x28);
    mic1Thresholds.ct_max = EEPROM_Read16(0x2A);
    mic1Thresholds.sh_min = EEPROM_Read16(0x2C);
    mic1Thresholds.sh_max = EEPROM_Read16(0x2E);
    ...
    if ((mic1Thresholds.ok_min == 0xFFFF && mic1Thresholds.ok_max == 0xFFFF) ||
        ...
        EEPROM_Write16(0x20, 480);
        EEPROM_Write16(0x22, 515);
        EEPROM_Write16(0x24, 300);
        EEPROM_Write16(0x26, 350);
        EEPROM_Write16(0x28, 900);
        EEPROM_Write16(0x2A, 1023);
        EEPROM_Write16(0x2C, 0);
        EEPROM_Write16(0x2E, 5);
    }
}

void saveMic1ThresholdsToEEPROM(void) {
    EEPROM_Write16(0x20, mic1Thresholds.ok_min);
    EEPROM_Write16(0x22, mic1Thresholds.ok_max);
    EEPROM_Write16(0x24, mic1Thresholds.pr_min);
    EEPROM_Write16(0x26, mic1Thresholds.pr_max);
    EEPROM_Write16(0x28, mic1Thresholds.ct_min);
    EEPROM_Write16(0x2A, mic1Thresholds.ct_max);
    EEPROM_Write16(0x2C, mic1Thresholds.sh_min);
    EEPROM_Write16(0x2E, mic1Thresholds.sh_max);
}
